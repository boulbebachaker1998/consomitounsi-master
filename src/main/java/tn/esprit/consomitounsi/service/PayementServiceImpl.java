...
import tn.esprit.consomitounsi.repository.PayementRepository;
...
public class PayementServiceImpl implements PayementService {
	...
	@Override
	public List<Payement> retrieveAllPayement(long userid) {
		User user=userService.findUserById(userid);
		List<Payement> payements=(List<Payement>)payementRepository.getUserPayements(user);
		return payements;
	}
}